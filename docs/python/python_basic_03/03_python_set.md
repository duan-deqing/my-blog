...
1. 创建一个集合，包含数字 1 到 10 的平方。
2. 创建一个集合，包含字符串"hello"中的所有唯一字符。
3. 创建一个集合，包含列表[1, 2, 3, 4, 5]中的所有偶数。
4. 创建一个集合，包含字典{'a': 1, 'b': 2, 'c': 3}中的所有键。
5. 创建一个集合，包含元组(1, 2, 3, 4, 5)中的所有元素。
6. 创建一个集合，包含列表[1, 2, 3, 4, 5]中的所有奇数。
7. 创建一个集合，包含字典{'a': 1, 'b': 2, 'c': 3}中的所有值。
8. 创建一个集合，包含元组(1, 2, 3, 4, 5)中的所有元素，并去除重复元素。
9. 创建一个集合，包含列表[1, 2, 3, 4, 5]中的所有元素，并去除重复元素。
10. 创建一个集合，包含字典{'a': 1, 'b': 2, 'c': 3}中的所有键，并去除重复元素。
